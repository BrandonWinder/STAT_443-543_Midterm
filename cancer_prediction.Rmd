...
## The Logistic Model
First we created a model for prediction with all of the variables used in the model.  We then created contigency tables and found the sensitivity, specificity, and the overall accuracy of the model.
```{r}
...
breastcancer_blind = breastcancer.test.blinded
# Modify the data frame with all the transformations.
