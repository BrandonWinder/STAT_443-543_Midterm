...
```
# Results Summary
In conclusion, the backwards elimation model is the best model for predicing whether a cancerous breast tissue is malignant or benign.  This comes from how the backwards elimanation model has the highest accuracy of all three models tested and also has the lowest amount of predictors in any of the models. The accuracy of this model was 97.4% and the classification threshold we choose was at 0.5. This model also has a sensivity of 95.2% and a specifiity of 98.6%. Overall, the backwards elimanation model does the best job in all categories of predicting cancerous breast tissue.
